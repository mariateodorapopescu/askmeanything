...
export default function App() {
  ...
  return (
    ...
    <div className="max-h-full h-screen w-full bg-[#dcd0c0] flex items-center justify-center px-4 overflow-hidden">
      <div className="w-full max-w-md flex flex-col gap-4 items-center">
        ...
        {/* <Button
          ...
          onClick={handleSubmit}
          className="font-montserrat border-[#8b6f47] data-[hover=true]:bg-[#8b6f47] hover:bg-[#8b6f47] w-full py-4 px-6 text-white  font-medium text-lg transition-all duration-300 transform hover:scale-105"
          variant="ghost"
          radius="none"
        ...
        >
          ...
          <Button
          onClick={() => googleLogin()}  // ← Aici e schimbarea!
          className="font-montserrat border-[#8b6f47] data-[hover=true]:bg-[#8b6f47] hover:bg-[#8b6f47] w-full py-4 px-6 text-white font-medium text-lg transition-all duration-300 transform hover:scale-105"
          variant="ghost"
          radius="none"
        >
